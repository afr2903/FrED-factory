...
class SnapArm:
    ...
    def execute_ok_routine(self):
        ...
        self.ok_counter += 1
        datatmp = bytearray(self.ok_counter.to_bytes(2,"big"))
        self.plc_action_data[0] = datatmp[0]
        self.plc_action_data[1] = datatmp[1]
    ...
    def execute_scrap_routine(self):
        ...
        datatmp = bytearray(self.scrap_counter.to_bytes(2,"big"))
        self.plc_action_data[2] = datatmp[0]
        self.plc_action_data[3] = datatmp[1]
